...
All three delegation tool blocks use Pi's default boxed shell and background. Their compact custom content is one call line plus at most three result lines in either collapsed or expanded view.
