...
- **Partially superseded:** the `/dag-plan` planning command by [ADR 022](022-pi-auto-dag-execution-boundary.md); the widget lifecycle decisions remain valid.
