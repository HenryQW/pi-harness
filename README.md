...
| [`@henryqw/pi-herdr-subagents`](./packages/pi-herdr-subagents) | `pi install npm:@henryqw/pi-herdr-subagents` | Delegate bounded work to interactive Pi Workers in Herdr tabs. |
