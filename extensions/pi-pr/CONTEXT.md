...
A deterministic reason that PR discovery cannot safely select creation, linking, or another workflow. Examples include ambiguous remotes or PRs, an OID mismatch, a published branch without a PR, unsafe Git configuration, and missing or ambiguous parent evidence.
