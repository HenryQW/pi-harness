...
- After user approval and publication, reply with only the published commit URL for an addressed thread, or the approved reason for a non-actionable thread, then resolve it. Leave blocked threads open.
